...
import org.dockbox.pipeline.CancelBehaviour;
import org.dockbox.pipeline.exceptions.IllegalPipeException;
import org.dockbox.pipeline.pipes.CancellablePipe;
import org.dockbox.pipeline.pipes.ComplexPipe;
import org.dockbox.pipeline.pipes.IPipe;
import org.dockbox.pipeline.pipes.StandardPipe;
...
public abstract class AbstractPipeline<P, I> {
    ...
    protected Exceptional<I> processPipe(final IPipe<I, I> pipe, Exceptional<I> exceptionalInput) {
        if (!this.cancellable() && CancellablePipe.class.isAssignableFrom(pipe.type())) {
        ...
        exceptionalInput = Exceptional.of(() -> {
            if (ComplexPipe.class.isAssignableFrom(pipe.type())) {
            ...
            else if (StandardPipe.class.isAssignableFrom(pipe.type())) {
