...
import org.dockbox.pipeline.PipelineDirection;
import org.dockbox.pipeline.exceptions.IllegalPipelineException;
...
public class ConvertiblePipeline<P, I> extends AbstractPipeline<P, I> {
    ...
    public <K> ConvertiblePipeline<P, K> remove(final Class<K> previousClass) {
        ...
        if (null == this.previous()) {
            ...
            if (previousClass.isAssignableFrom(this.previous().input())) {
